...
func (m *MockEmailSender) SendEmail(topic, text string, targetEmails []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendEmail", topic, text, targetEmails)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendEmail indicates an expected call of SendEmail.
func (mr *MockEmailSenderMockRecorder) SendEmail(topic, text, targetEmails any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendEmail", reflect.TypeOf((*MockEmailSender)(nil).SendEmail), topic, text, targetEmails)
}
